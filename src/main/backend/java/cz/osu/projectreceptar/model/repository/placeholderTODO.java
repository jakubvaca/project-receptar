...
public class placeholderTODO {
    ...
    TODO: Udelat databazi, vytvorit entity pro recepty, ingredience, uzivatele, atd. a nastavit vztahy mezi nimi. Navrh na stranky neon.com? -  digitalocean? - MS azure? - v github student packu credity
        1. Recepty (id, nazev, popis, postup, cas_pripravy, cas_vareni, cas_celkove, porce, autor_id) - mby pridat casy
        2. Ingredience (id, nazev)
        3. Uzivatele (id, username, email, password_hash)
        4. Recept_Ingredience (id, recept_id, ingredience_id, mnozstvi, jednotka)
